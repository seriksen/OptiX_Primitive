...
int main(int argc, char** argv)
{
  ...
  box->setIntersectionProgram( context->creatProgramFromPTXFile( box_ptx, "robust_intersect") );
  box->setIntersectionProgram( context->creatProgramFromPTXFile( box_ptx, "intersect_sphere") );
